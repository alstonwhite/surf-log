                    ...
                    <Accordion.Collapse eventKey="0">
                      <Container>
                        <Card.Title>
                          ...
                          <ListGroup>
                              {data ? data.map(board => <ListGroupItem key={board.id} size="sm">{board.name}</ListGroupItem>) :
                        ...
                        <Form onSubmit={handleSubmit}>
                            <Form.Group as={Col} controlId="formGridBoard">
                                ...
                                <Form.Control type="board" ref={boardRef} placeholder="New board name"size="sm"></Form.Control>
                            </Form.Group>
                            <Button type="submit" disabled={loading}>Add Board</Button>
                        </Form>
                      </Container>
                    </Accordion.Collapse>
