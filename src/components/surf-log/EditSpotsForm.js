      ...
      <Accordion>
        <Container>
          ...
          <Accordion.Collapse eventKey="0">
            <Container>
              <Card.Title>Current Spots</Card.Title>
              <ListGroup>
                {data ? (
                  data.map((spot) => (
                    <ListGroupItem key={spot.id} size="sm">
                      {spot.name}
                    </ListGroupItem>
                  ))
                ) : (
              ...
              <Form onSubmit={handleSubmit}>
                <Form.Group as={Col} controlId="formGridSpotId">
                  ...
                  <Form.Control
                    type="spot"
                    ref={spotIdRef}
                    placeholder="New spot ID"
                    size="sm"
                  ></Form.Control>
                  <Form.Text className="text-muted">
                    Find spot ID in Surfline web address (ex:
                    www.surfline.com/surf-report/90th-st-rockaways/
                    <span style={{ color: "red" }}>
                      <b>5842041f4e65fad6a7708852</b>
                    </span>
                    )
                  </Form.Text>
                </Form.Group>
